...
def draw(canvas):
    ...
    canvas.draw_text("Score:"+ str(score), [625,50],30, "RED")
# timer handler that spawns a rock    
def rock_spawner():
    global a_rock
    random_width=random.random()*WIDTH
    random_height=random.random()*HEIGHT
    
    a_rock = Sprite([random_width, random_height], [random.random(), random.random()], random.random(), random.random()*0.1, asteroid_image, asteroid_info)
